...
func (repo CloudControllerAppInstancesRepository) GetInstances(appGuid string) (instances []cf.ApplicationInstance, apiResponse net.ApiResponse) {
...
func (repo CloudControllerAppInstancesRepository) updateInstancesWithStats(guid string, instances []cf.ApplicationInstance) (updatedInst []cf.ApplicationInstance, apiResponse net.ApiResponse) {
